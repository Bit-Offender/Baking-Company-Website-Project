      ...
      <div className="grid grid-cols-2 gap-10 items-center ml-10">
        <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-7">
              <Link href="/orders">
                  <button className="text-amber-800 font-bold hover:bg-amber-800 hover:text-white px-4 py-2 rounded">Order Now</button>
              </Link>
              <button className="flex gap-2 items-center text-amber-800 font-bold hover:bg-amber-800 hover:text-white px-3 py-2 rounded">
